...
class TestCreateRecordResponse:
    ...
    async def test_create_record_submitted_response_increases_record_count_submitted_responses(
    ...
    async def test_create_record_not_submitted_response_does_not_increase_record_count_submitted_responses(
