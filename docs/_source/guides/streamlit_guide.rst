...
We've created a `standalone repository <https://github.com/recognai/argilla-streamlit-example>`_\  for this streamlit app, for you to clone and play around. To run the app, follow these steps:
