...
:::{note}
In future versions, Argilla will include a `RankingQuestion`, especifically tailored for this workflow.You can track the progress, provide feedback, and leave comments on [this GitHub issue](https://github.com/argilla-io/argilla/issues/3021).
:::
