...
To visualize the desired effect of supervised fine-tuning, let's see two examples generated by LLMs. First, the model [Falcon-7B](https://huggingface.co/tiiuae/falcon-7b) which is not fine-tuned for following instructions:
