...
For transparency, you can inspect the source code where this is performed [here](https://github.com/recognai/rubrix/blob/releases/1.x/src/argilla/server/commons/telemetry.py#L53).
