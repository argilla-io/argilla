...
If you want to explore your dataset or analyze the predictions of a model, the Argilla web app offers a dedicated Explore mode.
...
The way they are presented in the Argilla web app depends on the [task](../../guides/task_examples.ipynb) of the dataset.
