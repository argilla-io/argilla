from rubric.sdk.client import Client, AuthenticatedClient
from rubric.sdk.models import *
from rubric.sdk.api.text_classification import bulk_records
from rubric.sdk.api.token_classification import bulk_records as bulk_records_ner
    ...
    def log(self, records, dataset, chunk_size=200, task="textcat"):
        ...
        if len(records) <= chunk_size:
            ...
            for i in range(0, len(records), chunk_size):
                ...
                response = bulk_records_fn.sync_detailed(client=self.client, json_body=bulk_cls(
                    name=dataset, 
                    records=chunk
                ))
                print(response)
