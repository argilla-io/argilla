...
from argilla_v1.client.sdk.text_classification.models import LabelingRule
...
class Rule:
    ...
    Args:
        query: An ElasticSearch query with the `query string syntax <https://docs.v1.argilla.io/en/latest/practical_guides/filter_dataset.html>`_.
