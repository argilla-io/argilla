...
class SpacesDeploymentMixin(LoggingMixin):
    ...
    def deploy_on_spaces(
        ...
        username: Optional[Union[str, None]] = "admin",
        ...
        Args:
            ...
            username (Optional[Union[str, None]]): The username of the admin user. Defaults to "admin".
        ...
        org_name = org_name or api.whoami(token=token)["name"]
