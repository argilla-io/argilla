...
class DatasetRecordsIterator:
    ...
    def _list(self) -> Sequence[Tuple[Record, Optional[float]]]:
        for record_model, score in self._fetch_from_server():
    ...
    def _fetch_from_server(self) -> List[Tuple[RecordModel, Optional[float]]]:
