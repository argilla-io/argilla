...
def deploy_on_spaces(
    ...
    exist_ok: Optional[Union[bool, None]] = False,
    ...
    Args:
        ...
        exist_ok (Optional[Union[bool, None]]): Whether to proceed if the space already exists. Defaults to False.
    ...
    from_id = from_repo_id_oauth if (oauth_huggingface_client_id and oauth_huggingface_client_secret) else from_repo_id
    secrets = [
    ...
    url: RepoUrl = api.duplicate_space(
        from_id=from_id,
        to_id=repo_id,
        private=private,
        token=token,
