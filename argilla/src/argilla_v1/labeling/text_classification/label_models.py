...
from argilla_v1 import DatasetForTextClassification, TextClassificationRecord
from argilla_v1.labeling.text_classification.weak_labels import WeakLabels, WeakMultiLabels
...
class Snorkel(LabelModel):
    ...
    Examples:
        >>> from argilla_v1.labeling.text_classification import WeakLabels
