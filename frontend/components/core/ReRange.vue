<template>
  <div ref="wrap" :class="['vue-slider-component', flowDirection, disabledClass, stateClass, { 'vue-slider-has-label': piecewiseLabel }]" v-show="show" :style="wrapStyles" @click="wrapClick">
    <div ref="elem" aria-hidden="true" class="vue-slider" :style="[elemStyles, bgStyle]">
      <div v-if="isRange">
        <div ref="dot0" :class="[
                          ...
                          : null]" @mousedown="moveStart($event, 0)" @touchstart="moveStart($event, 0)">
        ...
        <div ref="dot1" :class="[
                          ...
                          : null]" @mousedown="moveStart($event, 1)" @touchstart="moveStart($event, 1)">
      ...
      <div ref="process" :class="['vue-slider-process', { 'vue-slider-process-dragable': isRange && processDragable }]" :style="processStyle" @click="processClick" @mousedown="moveStart($event, 0, true)" @touchstart="moveStart($event, 0, true)"></div>
    </div>
...
.vue-slider-dot {
    .filter & {
        ...
        &:before {
            ...
            height: 7px;
            width: 7px;
            border-left: 1px solid palette(purple);
            border-right: 1px solid palette(purple);
        }
        &:after {
            content: '';
            @include absoluteCenter;
