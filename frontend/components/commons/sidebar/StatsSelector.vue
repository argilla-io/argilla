<template>
    <div class="selector">
      <p v-if="filteredOptions.length" class="selector__header" @click="openSelector">{{selectedOption.name}}</p>
      <p v-else>{{selectedOption.name}}</p>
      <transition name="fade">
      <ul class="selector__body"  v-if="showOptionsSelector" v-click-outside="onClickOutside">
