  ...
  <div class="error">
    <div class="container">
      <div class="error__content">
        ...
        <h1 class="error__title" v-else>An error occurred</h1>
        <p class="error__subtitle">The page you’re looking for can’t be found.</p>
        ...
        <g id="*-Documentation" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          <g id="error-message-explore" transform="translate(0.000000, -392.000000)">
            ...
            <path
              ...
              fill="#89D8F1"
            />
            <ellipse id="eye-1" fill="#FBFAED" cx="512.5" cy="486.5" rx="2.5" ry="4.5" />
            <path
