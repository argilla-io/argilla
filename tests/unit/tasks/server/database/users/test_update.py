...
def test_update(sync_db: "Session", cli_runner: CliRunner, cli: Typer, new_role_string: str):
    ...
    result = cli_runner.invoke(cli, f"server database users update username --role {new_role_string}")
...
def test_update_with_invalid_role(cli_runner: CliRunner, cli: Typer):
    ...
    result = cli_runner.invoke(cli, f"server database users update username --role {bad_role_str}")
...
def test_update_with_missing_username(cli_runner: CliRunner, cli: Typer):
    ...
    result = cli_runner.invoke(cli, f"server database users update {missing_username} --role owner")
...
def test_update_with_same_user_role(cli_runner: CliRunner, cli: Typer, role_string: str):
    ...
    result = cli_runner.invoke(cli, f"server database users update {username} --role {role_string}")
