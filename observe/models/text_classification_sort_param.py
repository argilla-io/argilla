...
class TextClassificationSortParam:
    """  """
    ...
    @staticmethod
    def from_dict(src_dict: Dict[str, Any]) -> "TextClassificationSortParam":
        d = src_dict.copy()
        ...
        text_classification_sort_param = TextClassificationSortParam(by=by, order=order,)

        text_classification_sort_param.additional_properties = d
        return text_classification_sort_param
