...
T = TypeVar("T", bound="TokenClassificationQueryMetadata")
...
class TokenClassificationQueryMetadata:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        token_classification_query_metadata = cls()
        ...
        token_classification_query_metadata.additional_properties = (
            additional_properties
        )
        return token_classification_query_metadata
