...
TERMS_METADATA_PROPERTY_MIN_ITEMS = 1
TERMS_METADATA_PROPERTY_MAX_ITEMS = 250
...
class TermsMetadataPropertyCreate(BaseModel):
    ...
    values: Optional[List[str]] = PydanticField(
        None, min_items=TERMS_METADATA_PROPERTY_MIN_ITEMS, max_items=TERMS_METADATA_PROPERTY_MAX_ITEMS
    )
