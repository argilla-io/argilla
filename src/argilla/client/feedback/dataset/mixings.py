...
class MetricsMixin:
    ...
    def compute_responses_metrics(
        self,
        metric_names: Union[str, List[str]] = None,
        question_name: Union[
            str, LabelQuestion, MultiLabelQuestion, RatingQuestion, RankingQuestion, TextQuestion
        ] = None,
        strategy: Optional[
            Union[
        ...
        """Compute metrics for the annotators using the responses as the ground truth, and the suggestions
        ...
        """
        from argilla.client.feedback.metrics.annotator_metrics import ResponsesMetric, UnifiedResponsesMetric

        if strategy:
            self.compute_unified_responses(question_name, strategy)
            return UnifiedResponsesMetric(self, question_name).compute(metric_names)
        else:
            return ResponsesMetric(self, question_name).compute(metric_names)

    def compute_suggestions_metrics(
        self,
        metric_names: Union[str, List[str]] = None,
        question_name: Union[
