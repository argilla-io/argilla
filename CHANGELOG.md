...
- Added `Remote{Terms,Integer,Float}MetadataProperty.update` to update either both or one of the `title` value and/or the `visible_for_annotators` flag in Argilla from the Python client ([#3961](https://github.com/argilla-io/argilla/pull/3961)).
