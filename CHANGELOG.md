...
- Updated `quickstart.Dockerfile` parent image from `elasticsearch:8.5.3` to `argilla/argilla-server:${ARGILLA_VERSION:-latest}` ([#3425](https://github.com/argilla-io/argilla/pull/3425)).
