...
- Added `RemoteSuggestionSchema` to manage suggestions in Argilla, including the `delete` method to delete those from Argilla ([#3651](https://github.com/argilla-io/argilla/pull/3651)).
- Added `delete_suggestions` to `RemoteFeedbackRecord` to remove pushed suggestions from Argilla ([#3651](https://github.com/argilla-io/argilla/pull/3651)).
